...
const data = [
  ...
  },
  {
    ...
    icon: (
      <HiOutlineBuildingOffice2 size={25} style={{ marginRight: "10px" }} />
    ),
    submenu: [],
  },
  {
...
export default function Navbar() {
  ...
  return ( 
    <div className="catalog-header-navbar">
      <ul>
        <li
          onClick={openToggle}
        ...
        <li>
          <Link to="/news">
            <BsFire color="red"></BsFire>Акции
          </Link>
        </li>
        <li>
          <Link to="/newProduct">
            <FaRegSnowflake></FaRegSnowflake> Кондиционеры
          </Link>
        </li>
        <li>
          <Link to="/Discounts">Смартфоны</Link>
        </li>
        <li>
          <Link to="/books">Холодильники</Link>
        </li>
        <li>
          <Link to="/telephones">Пылисосы</Link>
        </li>
        <li>
          <Link to="/tv">Ноутбуки</Link>
        </li>
        <li>
          <Link to="/sports">Все категории</Link>
        </li>
      </ul>
      {open ? <Menu /> : ""}
    </div>
